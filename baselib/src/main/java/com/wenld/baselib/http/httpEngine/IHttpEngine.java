package com.wenld.baselib.http.httpEngine;
...
public interface IHttpEngine {
    ...
    void uploadAPI(String url, Map<String, String> params, Map<String, String> headers, List<FileInput> files, EngineCallBack callback);
}
